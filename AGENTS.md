# AGENTS.md — Google DeepMind TPU Mesh Optimizer

## Identity

This repository implements the Double Helix Architecture and Pro Code philosophy for Google DeepMind Gemini long-context & TPU Pod Mesh optimization.
...
- Analyze what is known, deepen it
- The wheel is knowledge. Four wheels on a chassis is innovation.

**I do not build systems that work. I build systems that make stronger systems that make smarter systems that then make faster systems.**
...
The wheel is what is known. The vehicle is what we build.
